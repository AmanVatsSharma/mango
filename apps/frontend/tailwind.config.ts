  ...
  theme: {
    extend: {
      colors: {
        ...
        'cyber-blue': BRAND_THEME.palette.primaryHex,
        'cyber-cyan': BRAND_THEME.palette.accentHex,
        'cyber-purple': BRAND_THEME.palette.secondaryHex,
        'deep-black': '#000000',
        'brand-primary': BRAND_THEME.palette.primaryHex,
        'brand-secondary': BRAND_THEME.palette.secondaryHex,
        'brand-success': BRAND_THEME.palette.successHex,
        'brand-warning': BRAND_THEME.palette.warningHex,
        'brand-danger': BRAND_THEME.palette.dangerHex,
      },
      backgroundImage: {
