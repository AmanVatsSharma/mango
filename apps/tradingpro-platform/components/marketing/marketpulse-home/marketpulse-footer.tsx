/**
 * @file components/marketing/marketpulse-home/marketpulse-footer.tsx
 * @module marketing/marketpulse-home
 * @description Public marketing footer with MarketPulse navigation and support links.
 * @author StockTrade
 * @created 2026-02-19
 */
...
export function MarketPulseFooter(): React.JSX.Element {
  return (
