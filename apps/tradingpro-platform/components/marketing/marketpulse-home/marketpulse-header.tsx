/**
 * @file components/marketing/marketpulse-home/marketpulse-header.tsx
 * @module marketing/marketpulse-home
 * @description Public marketing header with desktop/mobile navigation for MarketPulse pages.
 * @author StockTrade
 * @created 2026-02-19
 */
...
export function MarketPulseHeader(): React.JSX.Element {
  return (
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            <Link
              ...
              className="marketpulse-cta-primary px-3 py-2 text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
            >
            ...
            <div className="absolute right-0 top-full z-50 mt-2 w-[min(92vw,360px)] overflow-hidden rounded-xl border bg-white shadow-2xl">
              <div className="p-3">
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  ...
                  <Link
                    href={routes.auth.register}
                    className="marketpulse-cta-primary px-3 py-2 text-center text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                  >
                    {BRAND_MARKETING.navigation.signupLabel}
                  </Link>
                </div>
