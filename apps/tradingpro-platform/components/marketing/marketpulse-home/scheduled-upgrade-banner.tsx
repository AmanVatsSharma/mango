/**
 * @file components/marketing/marketpulse-home/scheduled-upgrade-banner.tsx
 * @module marketing/marketpulse-home
 * @description Env-toggled scheduled upgrade banner for MarketPulse marketing pages.
 * @author StockTrade
 * @created 2026-02-19
 */
